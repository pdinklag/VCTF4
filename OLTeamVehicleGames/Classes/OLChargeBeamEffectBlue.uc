class OLChargeBeamEffectBlue extends OLChargeBeamEffect;

defaultproperties
{
	ShockImpactFlareClass=class'OLTeamsShockImpactFlareBlue'
	ShockImpactRingClass=class'OLTeamsShockImpactRingBlue'
	ShockExplosionCoreClass=class'OLTeamsShockExplosionCoreBlue'
	ShockImpactScorchClass=class'OLTeamsShockImpactScorchBlue'
    ...
    Begin Object Class=BeamEmitter Name=BeamEmitter1
        ...
        ColorScale(1)=(RelativeTime=0.800000,Color=(B=192,G=128,R=128))
        ColorScale(2)=(RelativeTime=1.000000)
        Opacity=0.400000
        MaxParticles=1
        StartLocationOffset=(Y=-12.000000)
