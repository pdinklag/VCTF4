class OLHoverBike extends ONSHoverBike;
...
defaultproperties
{
	DriverWeapons(0)=(WeaponClass=class'OLHoverBikePlasmaGun',WeaponBone=PlasmaGunAttachment);
	...
	TeamSkins(0)=Shader'OLTeamVehicleGames.HoverBike.HoverBikeChassisFinalRed'
	TeamSkins(1)=Shader'OLTeamVehicleGames.HoverBike.HoverBikeChassisFinalBlue'
	TeamSkins(2)=Shader'OLTeamVehicleGames.HoverBike.HoverBikeChassisFinalGreen'
	TeamSkins(3)=Shader'OLTeamVehicleGames.HoverBike.HoverBikeChassisFinalGold'
	NeutralSkin=Texture'VMVehicles-TX.HoverBikeGroup.NewHoverCraftNOcolor'
}
