...
defaultproperties
{
	PassengerWeapons(0)=(WeaponPawnClass=class'OLPRVSideGunPawn',WeaponBone=Dummy01);
	PassengerWeapons(1)=(WeaponPawnClass=class'OLPRVRearGunPawn',WeaponBone=Dummy02);
