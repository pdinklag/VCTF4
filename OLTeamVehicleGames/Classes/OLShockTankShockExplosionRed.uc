class OLShockTankShockExplosionRed extends ONSShockTankShockExplosion;
...
defaultproperties
{
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter37
        ...
        UniformSize=True
        AutomaticInitialSpawning=False
        ColorScale(1)=(RelativeTime=0.500000,Color=(B=176,G=176,R=255))
        ColorScale(2)=(RelativeTime=1.000000)
        MaxParticles=1
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter35
        ...
        UniformSize=True
        AutomaticInitialSpawning=False
        ColorScale(1)=(RelativeTime=0.200000,Color=(B=111,G=111,R=255))
        ColorScale(2)=(RelativeTime=0.800000,Color=(B=85,G=85,R=255))
        ColorScale(3)=(RelativeTime=1.000000)
        Opacity=0.500000
        MaxParticles=1
    ...
    Begin Object Class=MeshEmitter Name=MeshEmitter10
        ...
        UniformSize=True
        AutomaticInitialSpawning=False
        ColorScale(0)=(Color=(B=108,G=108,R=255))
        ColorScale(1)=(RelativeTime=0.700000,Color=(B=157,G=157,R=255))
        ColorScale(2)=(RelativeTime=1.000000)
        MaxParticles=1
        SizeScale(1)=(RelativeTime=1.000000,RelativeSize=5.000000)
        InitialParticlesPerSecond=500.000000
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter36
        ...
        UniformSize=True
        AutomaticInitialSpawning=False
        ColorScale(0)=(Color=(B=138,G=138,R=255))
        ColorScale(1)=(RelativeTime=0.700000,Color=(B=83,G=83,R=255))
        ColorScale(2)=(RelativeTime=1.000000)
        MaxParticles=1
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter1
        ...
        UniformSize=True
        AutomaticInitialSpawning=False
        ColorScale(1)=(RelativeTime=0.100000,Color=(B=74,G=74,R=255))
        ColorScale(2)=(RelativeTime=0.800000,Color=(B=108,G=108,R=255))
        ColorScale(3)=(RelativeTime=1.000000)
        CoordinateSystem=PTCS_Relative
        MaxParticles=6
