class OLVehicleCTFGame extends OLCTFGame config;
...
function GetServerInfo(out ServerResponseLine ServerState)
{
	...
	ServerState.GameType = "xVehicleCTFGame"; //report self as VCTF
}

defaultproperties
{
	MapListType="OLTeamVehicleGames.MapListOLVCTF"
	MapPrefix="VCTF4"
	BeaconName="VCTF4"
	Acronym="VCTF4"
	GameName="VCTF4"
	Description="Like CTF4, but with vehicles!"
	MutatorClass="OLTeamVehicleGames.OLVehicleMutator"
	PlayerControllerClassName="OLTeamVehicleGames.OLVehiclePlayerController"
	bAllowVehicles=True
	bAllowTrans=False
	bDefaultTranslocator=False
	bFlagElimination=True
	bCanSeeFlagLocation=False
	bCarryFlagBack=False
	bMultiFlagCarry=True
	bTranslocateWithFlags=False
}
