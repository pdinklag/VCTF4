class OLAttackCraft extends ONSAttackCraft;
...
defaultproperties
{
	DriverWeapons(0)=(WeaponClass=class'OLAttackCraftGun',WeaponBone=PlasmaGunAttachment)
	...
	TeamSkins(0)=Shader'OLTeamVehicleGames.AttackCraft.AttackCraftChassisFinalRed'
	TeamSkins(1)=Shader'OLTeamVehicleGames.AttackCraft.AttackCraftChassisFinalBlue'
	TeamSkins(2)=Shader'OLTeamVehicleGames.AttackCraft.AttackCraftChassisFinalGreen'
	TeamSkins(3)=Shader'OLTeamVehicleGames.AttackCraft.AttackCraftChassisFinalGold'
	NeutralSkin=Texture'VMVehicles-TX.AttackCraftGroup.AttackCraftNoColor'
}
