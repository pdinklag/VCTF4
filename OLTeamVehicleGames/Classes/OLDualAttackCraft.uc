class OLDualAttackCraft extends ONSDualAttackCraft;
...
defaultproperties
{
    DriverWeapons(0)=(WeaponClass=class'OLDualACSideGun',WeaponBone=RightRLAttach);
    DriverWeapons(1)=(WeaponClass=class'OLDualACSideGun',WeaponBone=LeftRLAttach);
	PassengerWeapons(0)=(WeaponPawnClass=class'OLDualACGatlingGunPawn',WeaponBone=GatlingGunAttach);
	...
	TeamSkins(0)=Shader'OLTeamVehicleGames.Cicada.CicadaRedShader'
	TeamSkins(1)=Shader'OLTeamVehicleGames.Cicada.CicadaBlueShader'
	TeamSkins(2)=Shader'OLTeamVehicleGames.Cicada.CicadaGreenShader'
	TeamSkins(3)=Shader'OLTeamVehicleGames.Cicada.CicadaGoldShader'
	NeutralSkin=Texture'OLTeamVehicleGames.Cicada.CicadaNoColor'
}
