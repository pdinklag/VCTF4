class OLMAS extends ONSMobileAssaultStation;
...
defaultproperties
{
    DriverWeapons(0)=(WeaponClass=class'ONSMASRocketPack',WeaponBone=RocketPackAttach);
    DriverWeapons(1)=(WeaponClass=class'OLMASCannon',WeaponBone=MainGunPostBase);
	PassengerWeapons(0)=(WeaponPawnClass=class'OLMASSideGunPawn',WeaponBone=RightFrontGunAttach);
	PassengerWeapons(1)=(WeaponPawnClass=class'OLMASSideGunPawn',WeaponBone=LeftFrontGunAttach);
	PassengerWeapons(2)=(WeaponPawnClass=class'OLMASSideGunPawn',WeaponBone=RightRearGunAttach);
	PassengerWeapons(3)=(WeaponPawnClass=class'OLMASSideGunPawn',WeaponBone=LeftRearGunAttach);
	...
	TeamSkins(0)=Shader'OLTeamVehicleGames.MAS.MASredSHAD'
	TeamSkins(1)=Shader'OLTeamVehicleGames.MAS.MASblueSHAD'
	TeamSkins(2)=Shader'OLTeamVehicleGames.MAS.MASgreenSHAD'
	TeamSkins(3)=Shader'OLTeamVehicleGames.MAS.MASgoldSHAD'
	NeutralSkin=Texture'ONSFullTextures.MASGroup.LEVnoColor'
}
