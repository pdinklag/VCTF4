class OLChargeBeamEffectRed extends OLChargeBeamEffect;

defaultproperties
{
	ShockImpactFlareClass=class'OLTeamsShockImpactFlareRed'
	ShockImpactRingClass=class'OLTeamsShockImpactRingRed'
	ShockExplosionCoreClass=class'OLTeamsShockExplosionCoreRed'
	ShockImpactScorchClass=class'OLTeamsShockImpactScorchRed'
    ...
    Begin Object Class=BeamEmitter Name=BeamEmitter1
        ...
        ColorScale(1)=(RelativeTime=0.800000,Color=(B=128,G=128,R=192))
        ColorScale(2)=(RelativeTime=1.000000)
        Opacity=0.400000
        MaxParticles=1
        StartLocationOffset=(Y=-12.000000)
