class OLTurretBeamEffectGreen extends ONSTurretBeamEffect;
...
simulated function SpawnEffects(vector HitLocation, vector HitNormal)
{
	...
	{
		bFogDist = true;
		Spawn(class'OLTeamsShockImpactFlareGreen',,, HitLocation, HitRotation);
		Spawn(class'OLTeamsShockExplosionCoreGreen',,, HitLocation+HitNormal*8, HitRotation);
	}
	...
	{
		Spawn(class'OLTeamsShockImpactRingGreen',,, HitLocation, HitRotation);
		Spawn(class'OLTeamsShockImpactScorchGreen',,, HitLocation, rotator(-HitNormal));
	}	
}
...
defaultproperties
{
    Begin Object Class=BeamEmitter Name=BeamEmitter4
        ...
        UseColorScale=True
        ColorScale(0)=(Color=(B=50,G=128,R=50))
        ColorScale(1)=(RelativeTime=0.800000,Color=(B=100,G=192,R=100,A=128))
    ...
    Begin Object Class=BeamEmitter Name=BeamEmitter5
        ...
        ColorScale(1)=(RelativeTime=0.800000,Color=(G=255))
        ColorScale(2)=(RelativeTime=1.000000)
        Opacity=0.800000
        MaxParticles=1
        RespawnDeadParticles=False
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter1
        ...
        UseColorScale=True
        ColorScale(1)=(RelativeTime=0.200000,Color=(B=55,G=140,R=55))
        ColorScale(2)=(RelativeTime=0.650000,Color=(B=23,G=132,R=23))
