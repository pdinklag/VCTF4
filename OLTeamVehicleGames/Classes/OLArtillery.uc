class OLArtillery extends ONSArtillery;
...
defaultproperties
{
	DriverWeapons(0)=(WeaponClass=class'OLArtilleryCannon',WeaponBone=CannonAttach);
	PassengerWeapons(0)=(WeaponPawnClass=class'OLArtillerySideGunPawn',WeaponBone=SideGunAttach);
