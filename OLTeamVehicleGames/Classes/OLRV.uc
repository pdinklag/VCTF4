...
defaultproperties
{
	DriverWeapons(0)=(WeaponClass=class'OLRVWebLauncher',WeaponBone=ChainGunAttachment);
	...
	TeamSkins(0)=Shader'OLTeamVehicleGames.RV.RVChassisFinalRED'
	TeamSkins(1)=Shader'OLTeamVehicleGames.RV.RVChassisFinalBLUE'
	TeamSkins(2)=Shader'OLTeamVehicleGames.RV.RVChassisFinalGREEN'
	TeamSkins(3)=Shader'OLTeamVehicleGames.RV.RVChassisFinalGOLD'
	NeutralSkin=Texture'VMVehicles-TX.RVGroup.NEWrvNoCOLOR'
}
