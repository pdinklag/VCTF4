class OLHoverTank extends ONSHoverTank;
...
defaultproperties
{
	DriverWeapons(0)=(WeaponClass=class'OLHoverTankCannon',WeaponBone=TankCannonWeapon)
	PassengerWeapons(0)=(WeaponPawnClass=class'OLTankSecondaryTurretPawn',WeaponBone=MachineGunTurret)
